...
def _render_service_bar(
    ...
    grafana_dot = "pm-dot-online" if grafana_online else "pm-dot-offline"
    prometheus_dot = "pm-dot-online" if prometheus_online else "pm-dot-offline"
    ...
    st.markdown(
        ...
        <div class="pm-service-bar">
            ...
            <a class="pm-service-link" href="{grafana_url}" target="_blank">
                <span class="pm-service-link-dot {grafana_dot}"></span>
                Grafana
            </a>
            <a class="pm-service-link" href="{prometheus_url}" target="_blank">
                <span class="pm-service-link-dot {prometheus_dot}"></span>
                Prometheus
            </a>
...
def _render_status_indicators(
    ...
    with col4:
        _status_row("Grafana", grafana_online)
    with col5:
        _status_row("Prometheus", prometheus_online)
